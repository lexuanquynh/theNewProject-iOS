...
class SelfPracticeCellNode: ASCellNode {
    let item: SelfPractice
    ...
    init(item: SelfPractice) {
        ...
        nameNode.attributedText = NSAttributedString(string:  "Name here", attributes: [
            NSAttributedString.Key.font: UIFont.systemFont(ofSize: 17, weight: .medium)
        ])
        descriptionNode.attributedText = NSAttributedString(string: "Description here", attributes: [
